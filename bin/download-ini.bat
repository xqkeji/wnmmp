...
REM MySQL: since 2026-07 the Innovation line uses calendar version YY.M.P
REM   26.7.0 = 2026-07 Innovation build (current latest); next is 26.10.0.
REM   The LTS line (9.7 / 8.4) keeps the old scheme; the two lines are parallel/independent.
REM   NOTE: the MySQL download site often returns 403, so auto-detection is unreliable;
REM   the pinned version below must be updated manually when a new release ships.
